        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <button class="btn btn-primary pull-right" data-toggle="modal" onclick="addMemberDueCollection()"
                    ...
                    <div class="form-group">
                        <div class="col-sm-5">
                            ...
                            <input type="text" id="member_name_1" class=" memberName form-control"
                                   placeholder="Search Supplier Name / Mobile / Address"  >
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
        <form action="" method="post" id="MemberDueCollectionForm" class="form-horizontal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-12">
                        ...
                        <button type="button" onclick="saveMemberDueCollection()" name="saveBtn" id="saveBtn"
                                class="btn
