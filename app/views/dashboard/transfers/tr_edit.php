    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- form start -->
                <form action="<?php echo base_url('transfers/update'); ?>" method="POST" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="transferNo" value="<?php echo $edit_info['transferNo'] ?>" type="text" readonly  class="form-control">
                                </div>                           
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>From Warehouse<sup>*</sup></label>
                                    <select id="fromWarehouseID" name="fromwhouse" class="form-control select2" style="width: 100%;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="toWarehouseID" name="towahouse" class="form-control select2" style="width: 100%;">
                        ...
                        <div>
                            <table class="table table-striped">
                                ...
                                <tbody id="tableDynamic">
                                    <?php
                                    $i = 1;
                                    foreach ($edit_infos as $key => $each_item) {
                                        ?>
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td>
                                                <input value="<?php echo $each_item['productID']; ?>" type="hidden" readonly="" name="productID[]" id="productName_<?php echo $key; ?>" placeholder="Product Name" class="form-control">
                                                <input value="<?php
                                    $PNAME_name = $this->COMMON_MODEL->get_single_data_by_single_column('tbl_pos_products', 'productID', $each_item['productID']);
                                    echo $PNAME_name['productName'];
                                        ?>" type="text" readonly="" id="productName_<?php echo $key; ?>" placeholder="Product Name" class="form-control">
                                            </td>
                                            <?php
                                            $totalsumeofproduct = $this->COMMON_MODEL->get_product_summationOfproduct('tbl_pos_inventory', 'productID', $each_item['productID'])->invoiceItemvalue;
                                            ?>
                                            <td>
                                                <input  type="text" readonly="" name="availableQuantity[]" id="availableQuantity_<?php echo $key; ?>" placeholder="Quantity"  value="<?php echo $totalsumeofproduct ?>" class="form-control">
                                            </td>
                                            <td>
                                                <input type="text" name="quantity[]" id="quantity_<?php echo $key; ?>" value="<?php echo $each_item['quantity'] ?>" placeholder="Quantity" class="quant form-control">
                                            </td>
                                            <td>
                                                <a href="javascript:void(0);" id="deleteRow_<?php echo $key; ?>" class="deleteRow btn btn-danger btn-flat btn-sm">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody> 
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td rowspan="5" style="border-top: medium none;">
                                        ...
                                        <textarea class="textarea" name="note" value="<?php echo $edit_info['note'] ?>"  placeholder="Note" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                    </td>
                                </tr>
                    ...
                    <div class="box-footer">
                        <button type="submit" id="submitBTN" class="btn btn-primary btn-flat"  onclick="return checkadd();">Update Transfer</button>
        ...
        if(selectedProductID){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('<tr><td>' + i + '</td><td><input value="'+data[0].inventory[0].productID+'" type="hidden" readonly name="productID[]" id="productName_' + i + '"  placeholder="Product Name" class="form-control"><input value="'+data[0].inventory[0].productName+' ('+data[0].inventory[0].productCode+')"  type="text" readonly id="productName_' + i + '"  placeholder="Product Name" class="form-control"></td><td><input value="'+data[0].inventory[0].inventory+'"  type="text" readonly name="availableQuantity[]" id="availableQuantity_' + i + '"  placeholder="Quantity" class="form-control"></td><td><input type="text" name="quantity[]" id="quantity_' + i + '"  placeholder="Quantity" class="quant form-control"></td><td><a href="javascript:void(0);" id="deleteRow_' + i + '"  class="deleteRow btn btn-danger btn-flat btn-sm">Delete</a></td></tr>').appendTo(scntDiv);
                }
            });
            i++;
            return false;
