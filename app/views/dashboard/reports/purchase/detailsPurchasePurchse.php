        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header" >
                    ...
                    <a href="<?php echo base_url('/reports/detailsPurchasePurchse') ?>" style="margin-left: 5px" class="btn btn-warning btn-sm pull-right no-print" ><i
                ...
                <form action="" method="post" id="purchaseReportForm">
                    <div class="form-group no-print">
                        ...
                        <div class="col-sm-2" style="margin-top:25px;">
                            <button type="button" onclick="searchingDetailsPurchaseReports()" class="btn btn-info" ><i
                                    class="glyphicon
